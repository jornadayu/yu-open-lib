...
`)),t(BA,{name:"Example",mdxType:"Story"}))}JA.isMDXComponent=!0;const aA=()=>"";aA.storyName="Example";aA.parameters={storySource:{source:"''"}};const G={title:"Hooks/useToggle",includeStories:["example"]},ja={Example:"example"};G.parameters=G.parameters||{};G.parameters.docs=u(r({},G.parameters.docs||{}),{page:()=>t(oe,{mdxStoryNameToKey:ja,mdxComponentMeta:G},t(JA,null))});var Fa=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",example:aA,default:G});const Ta={},La="wrapper";function XA(a){var n=a,{components:e}=n,o=v(n,["components"]);return t(La,u(r(r({},Ta),o),{components:e,mdxType:"MDXLayout"}),t(te,{title:"Hooks/useViewport",mdxType:"Meta"}),t("h1",null,"useViewport"),t("pre",null,t("code",{parentName:"pre",className:"language-tsx"},`import { useViewport } from 'yu-open-lib'
...
`)),t(BA,{name:"Example",mdxType:"Story"}))}XA.isMDXComponent=!0;const nA=()=>"";nA.storyName="Example";nA.parameters={storySource:{source:"''"}};const w={title:"Hooks/useViewport",includeStories:["example"]},Ea={Example:"example"};w.parameters=w.parameters||{};w.parameters.docs=u(r({},w.parameters.docs||{}),{page:()=>t(oe,{mdxStoryNameToKey:Ea,mdxComponentMeta:w},t(XA,null))});var Ja=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",example:nA,default:w});const Xa={},Oa="wrapper";function OA(a){var n=a,{components:e}=n,o=v(n,["components"]);return t(Oa,u(r(r({},Xa),o),{components:e,mdxType:"MDXLayout"}),t(te,{title:`${F.version}/AppTheme`,mdxType:"Meta"}),t("h3",null,"AppTheme Usage"),t("pre",null,t("code",{parentName:"pre",className:"language-tsx"},`import React from 'react'
...
`,locationsMap:{example:{startLoc:{col:55,line:16},endLoc:{col:1,line:31},startBody:{col:55,line:16},endBody:{col:1,line:31}},"loading-confirmation":{startLoc:{col:55,line:16},endLoc:{col:1,line:31},startBody:{col:55,line:16},endBody:{col:1,line:31}},"custom-children":{startLoc:{col:55,line:16},endLoc:{col:1,line:31},startBody:{col:55,line:16},endBody:{col:1,line:31}}}}},title:"Dialogs/ConfirmDialog",component:le,argTypes:{handleConfirm:{action:"handleConfirm"},handleClose:{action:"handleClose"}}};const iA=e=>{const[o,a]=S.exports.useState(!1),n=()=>{e.handleClose(),a(!1)};return p(ne,{children:[A("button",{onClick:()=>a(!0),children:"Open Dialog"}),A(le,u(r({},e),{open:o,handleClose:n}))]})},sA={title:"Dialog Title",confirmText:"Confirm",cancelText:"Cancel",text:"Do you want to confirm?"},$A=iA.bind({});$A.args=r({},sA);const eo=iA.bind({});eo.args=u(r({},sA),{loading:!0});const Ao=iA.bind({});Ao.args=u(r({},sA),{children:p("div",{children:["custom ",A("strong",{children:"dialog"})," ",A("em",{children:"content"})," with"," ",A("span",{style:{color:"red"},children:"JSX"})]})});const ln=["Example","LoadingConfirmation","CustomChildren"];var sn=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:rn,Example:$A,LoadingConfirmation:eo,CustomChildren:Ao,__namedExportsOrder:ln}),un={title:"Dialogs/DialogTitle",component:M,argTypes:{onClose:{action:"onClose"}},parameters:{storySource:{source:`import React, { useState } from 'react'
...
`,locationsMap:{"static-values":{startLoc:{col:53,line:14},endLoc:{col:1,line:20},startBody:{col:53,line:14},endBody:{col:1,line:20}},percentage:{startLoc:{col:53,line:14},endLoc:{col:1,line:20},startBody:{col:53,line:14},endBody:{col:1,line:20}}}}},title:"Graphs/YuWordCloud",component:me};const Bo=e=>A(k,{container:!0,children:A(R,{style:{height:"100%",width:"100%",padding:24},children:A(me,r({},e))})}),C=()=>Math.floor(Math.random()*(100-5)+5),dA=[{text:"Stuff",value:C()},{text:"Other",value:C()},{text:"Computer",value:C()},{text:"Headset",value:C()},{text:"Video",value:C()},{text:"Monitor",value:C()},{text:"People",value:C()},{text:"Shirt",value:C()},{text:"Umbrella",value:C()},{text:"Another",value:C()},{text:"Day",value:C()},{text:"Thing",value:C()},{text:"Car",value:C()},{text:"House",value:C()},{text:"Person",value:C()},{text:"Light",value:C()}],$n=dA.reduce((e,o)=>e+(o.value||0),0),er=dA.map(e=>u(r({},e),{value:e.value/$n})),Po=Bo.bind({});Po.args={words:dA};const Wo=Bo.bind({});Wo.args={words:er,isPercentage:!0,precision:2};const Ar=["StaticValues","Percentage"];var or=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:_n,StaticValues:Po,Percentage:Wo,__namedExportsOrder:Ar}),tr={parameters:{storySource:{source:`import React from 'react'
