...
`)),t(CA,{name:"Example",mdxType:"Story"}))}TA.isMDXComponent=!0;const eA=()=>"";eA.storyName="Example";eA.parameters={storySource:{source:"''"}};const G={title:"Hooks/useViewport",includeStories:["example"]},Qa={Example:"example"};G.parameters=G.parameters||{};G.parameters.docs=u(r({},G.parameters.docs||{}),{page:()=>t(oe,{mdxStoryNameToKey:Qa,mdxComponentMeta:G},t(TA,null))});var Da=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",example:eA,default:G});const xa={},Ba="wrapper";function LA(a){var n=a,{components:e}=n,o=N(n,["components"]);return t(Ba,u(r(r({},xa),o),{components:e,mdxType:"MDXLayout"}),t(te,{title:`${j.version}/AppTheme`,mdxType:"Meta"}),t("h3",null,"AppTheme Usage"),t("pre",null,t("code",{parentName:"pre",className:"language-tsx"},`import React from 'react'
...
`,locationsMap:{"common-rejection":{startLoc:{col:60,line:16},endLoc:{col:1,line:22},startBody:{col:60,line:16},endBody:{col:1,line:22}}}}},title:"Graphs/RejectionsSunburst",component:pe};const Cn=e=>A(v,{container:!0,style:{height:500},children:A(C,{style:{height:"100%",width:"100%",padding:24},children:A(pe,r({},e))})}),kn={name:"rejections",color:"hsl(258, 70%, 50%)",children:[{name:"Sem interesse",children:[{count:45,name:"Sem interesse - VVVVVV",color:"hsl(13, 70%, 50%)"},{count:12,name:"Sem interesse - ZZZZZZ",color:"hsl(13, 70%, 50%)"},{count:6,name:"Sem interesse - XXXXXXX",color:"hsl(13, 70%, 50%)"}]},{name:"T\xE9cnico",children:[{count:23,name:"T\xE9cnico - QQQQQQQQ",color:"hsl(13, 70%, 50%)"},{count:67,name:"T\xE9cnico - DDDDDD",color:"hsl(13, 70%, 50%)"},{count:23,name:"T\xE9cnico - BBBBBB",color:"hsl(13, 70%, 50%)"},{count:43,name:"T\xE9cnico - CCCCCC",color:"hsl(13, 70%, 50%)"},{count:54,name:"T\xE9cnico - AAAAAA",color:"hsl(13, 70%, 50%)"},{count:76,name:"T\xE9cnico - YYYYYY",color:"hsl(13, 70%, 50%)"},{count:4,name:"T\xE9cnico - GGGGGG",color:"hsl(13, 70%, 50%)"}]},{name:"Outros",children:[{count:12,name:"Outros - FFFFF",color:"hsl(13, 70%, 50%)"},{count:4,name:"Outros - VVVVV",color:"hsl(13, 70%, 50%)"}]},{name:"Comportamental",children:[{count:7,name:"Comportamental - XXXXX",color:"hsl(13, 70%, 50%)"},{count:2,name:"Comportamental - ZZZZZ",color:"hsl(13, 70%, 50%)"},{count:2,name:"Comportamental - YYYYY",color:"hsl(13, 70%, 50%)"}]}]},So=Cn.bind({});So.args={data:kn};const Rn=["CommonRejection"];var Qn=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:qn,CommonRejection:So,__namedExportsOrder:Rn});const Dn="ClickableArea",yo={clickArea:`${Dn}-clickArea`},xn=ae("span")(()=>({[`& .${yo.clickArea}`]:{cursor:"pointer",outline:"none"}})),_=({onClick:e,children:o,active:a=!0,useKeybinding:n=!0,keybinding:l="space"})=>A(xn,{role:"button",tabIndex:0,onClick:a?e:void 0,onKeyDown:a?s=>{s.key===l&&n&&e()}:void 0,className:a?yo.clickArea:void 0,children:o});try{_.displayName="ClickableArea",_.__docgenInfo={description:`Use around a component to have it as a clickable area with a onClick callback
